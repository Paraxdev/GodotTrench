...
| `validate_map` | Accepts any method or property of the target's Godot class or script as an input. Reports `coplanar_faces` for overlapping faces that z-fight in Godot |
