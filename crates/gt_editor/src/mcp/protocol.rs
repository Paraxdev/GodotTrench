...
pub fn tool_definitions() -> Vec<Value> {
    ...
    vec![
        ...
        json!({
            "name": "screenshot",
            "description": "PNG of the whole window or of one viewport. Use after changes to verify them visually. width and height render a view's camera offscreen at that size (up to 4096), without the gizmos and overlays, larger than its docked pane.",
            "inputSchema": { "type": "object", "properties": {
